...
function login1() {
    ...
    auth.signInWithEmailAndPassword(loginemail, loginpassword).then(() => {
        ...
        const loginpagecontainer1 = document.getElementsByClassName('logincontainer')[0];
        
        loginpagecontainer1.classList.remove('loginpage-container-active');
         const logindata1 = document.getElementsByClassName('logindatacontainer')[0];
        logindata1.style.display = "none";
       ...
       var alertvalue = document.getElementById('alertcontainer');
        ...
        alertpara.innerText = "Login Success";
        var counter = 8;
